...
In this tutorial, we will begin with a basic RDF query using an link:https://raw.githubusercontent.com/jbarrasa/neosemantics/3.5/docs/rdf/nsmntx.ttl[example RDF query in Turtle format^].
This file is hosted on the link:https://raw.githubusercontent.com/jbarrasa/neosemantics/[Neosemantics Github Repository^].

[source,turtle]
----
include::https://raw.githubusercontent.com/jbarrasa/neosemantics/3.5/docs/rdf/nsmntx.ttl[]
----
